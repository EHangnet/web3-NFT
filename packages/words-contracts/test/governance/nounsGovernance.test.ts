...
import { WordsToken, WordsDescriptor__factory as WordsDescriptorFactory } from '../../typechain';
...
describe('Words Governance', () => {
  let snapshotId: number;
  let token: WordsToken;
  let tokenCallFromGuy: WordsToken;
  let tokenCallFromDeployer: WordsToken;
  ...
  before(async () => {
    ...
    domain = Domain('Words', token.address, await chainId());
