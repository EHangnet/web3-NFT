...
/// @title The Words DAO proxy contract
...
// LICENSE
// WordsDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// WordsDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract WordsDAOProxy is WordsDAOProxyStorage, WordsDAOEvents {
    constructor(
        address timelock_,
        address words_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'WordsDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'WordsDAOProxy::_setImplementation: invalid implementation address');
