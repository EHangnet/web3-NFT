...
task('deploy', 'Deploys NFTDescriptor, WordsDescriptor, WordsSeeder, and WordsToken')
  .addParam('worddersdao', 'The wordders DAO contract address', undefined, types.string)
    ...
    const contracts: Record<ContractName, Contract> = {
      ...
      WordsToken: {
        args: [
          ...
          () => contracts['WordsDescriptor'].address,
          () => contracts['WordsSeeder'].address,
      ...
      WordsAuctionHouseProxy: {
        args: [
          () => contracts['WordsAuctionHouse'].address,
          () => contracts['WordsAuctionHouseProxyAdmin'].address,
          () =>
            new Interface(WordsAuctionHouseABI).encodeFunctionData('initialize', [
              contracts['WordsToken'].address,
              args.weth,
      ...
      WordsDAOProxy: {
        args: [
          () => contracts['WordsDAOExecutor'].address,
          () => contracts['WordsToken'].address,
          args.worddersdao,
          () => contracts['WordsDAOExecutor'].address,
          () => contracts['WordsDAOLogicV1'].address,
          args.votingPeriod,
          args.votingDelay,
