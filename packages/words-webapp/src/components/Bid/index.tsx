import { Auction, AuctionHouseContractFunction } from '../../wrappers/wordsAuction';
...
import { useAuctionMinBidIncPercentage } from '../../wrappers/wordsAuction';
...
const Bid: React.FC<{
  ...
  const wordsAuctionHouseContract = new WordsAuctionHouseFactory().attach(
  ...
  const placeBidHandler = async () => {
    ...
    const contract = connectContractToSigner(wordsAuctionHouseContract, undefined, library);
    const gasLimit = await contract.estimateGas.createBid(auction.wordId, {
      value,
    });
    placeBid(auction.wordId, {
      value,
